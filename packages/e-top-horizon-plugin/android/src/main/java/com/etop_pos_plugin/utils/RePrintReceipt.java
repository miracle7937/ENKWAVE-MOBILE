...
public class RePrintReceipt {
    ...
    public RePrintReceipt(Context context, Map<String, String> mp, String merchantName, String transactionTitle) {
        try {
    ...
    private Bitmap generateTestBitmap(String title) {
        ...
        combBitmap.addBitmap(GenerateBitmap.str2Bitmap(transactionTitle, 20, GenerateBitmap.AlignEnum.CENTER, true, false));
    ...
    public void print() {
        try {
            ...
            items.add(generateTestBitmap("******  REPRINT ******"));
            if (printDouble) {
                items.add(generateTestBitmap("****** REPRINT ******"));
            }
