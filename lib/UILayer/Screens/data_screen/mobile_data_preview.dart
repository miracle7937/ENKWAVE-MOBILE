...
class MobileDataPreview extends StatelessWidget {
  const MobileDataPreview({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    MobileDataController mobileDataController =
        Provider.of<MobileDataController>(context);
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              getAirtimeTitle(
                                  mobileDataController.getNetworkSelector),
                              style: Theme.of(context)
                                  .textTheme
                                  .headline1!
                                  .copyWith(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              mobileDataController.mobileNumber.toString(),
                              style: Theme.of(context)
                                  .textTheme
                                  .headline1!
                                  .copyWith(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const Spacer(),
                          Text(
                            "NGN${mobileDataController.basePackage!.getAmount}",
                            style: Theme.of(context)
                                .textTheme
                                .headline1!
                                .copyWith(
