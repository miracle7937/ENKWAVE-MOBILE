class EPImages {
  ...
  static String flightTicket = "$root/flightTicket.png";
  static String insurance = "$root/insurance.png";
  ...
  static String logoIcon = "$root/logo.png";
  ...
  static String contactIcon = "$root/contact.png";
  static String forwardArrow = "$root/forward_arrow.png";
  static String cableTv = "$root/cable_tv.png";
  ...
  //airtime
  static String mtnIcon = "$root/mtn.png";
  ...
  static String amount = "$root/amount.png";
  static String totalAmount = "$root/total_amount.png";

  //transfer
  static String inAppTransfer = "$root/transfe_app_user.png";
  static String bankTransfer = "$root/bank_transfer.png";
