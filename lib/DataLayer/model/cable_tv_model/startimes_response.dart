...
class StarTimesResponseModel extends BasePackage {
  String? variationCode;
  String? name;
  String? variationAmount;
  String? fixedPrice;

  StarTimesResponseModel.fromJson(Map<String, dynamic> json) {
    variationCode = json['variation_code'];
    name = json['name'];
    variationAmount = json['variation_amount'];
    fixedPrice = json['fixedPrice'];
    super.setValue(variationAmount!, name!, variationCode!, "startimes");
  }
